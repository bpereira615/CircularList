...
public interface List<T> {
    ...
    /*
     * NOTE THAT WE DON'T HAVE TO INCLUDE THE PUBLIC ACCESS MODIFIER SINCE ALL
     * METHODS IN AN INTERFACE ARE PUBLIC BY DEFAULT. CHECKSTYLE WANTS US TO USE
     * DEFAULT PERMISSIONS.
     */
    ...
    /**
     * Insert a value at the current location. The client must ensure that the
